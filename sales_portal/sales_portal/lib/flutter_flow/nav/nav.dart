...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AdminCompanyWidget.routeName,
          path: AdminCompanyWidget.routePath,
          builder: (context, params) => AdminCompanyWidget(),
        ),
        FFRoute(
          name: AdminProductWidget.routeName,
          path: AdminProductWidget.routePath,
          builder: (context, params) => AdminProductWidget(),
        ),
        FFRoute(
